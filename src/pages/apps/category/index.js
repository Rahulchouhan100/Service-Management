    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Card style={{ padding: "20px" }}>
          ...
          <TableHeader parentCategoryId={parentCategoryId} setParentCategoryId={setParentCategoryId} setShow={setShowCategory} />

          <TreeViewCustomized show={showCategory} setParentCategoryId={setParentCategoryId} setParentCategoryData={setParentCategoryData} parentCategoryId={parentCategoryId} parentCategoryData={parentCategoryData} setShow={setShowCategory} setShowProperty={setShowProperty} />
