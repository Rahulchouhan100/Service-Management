        ...
        <Card>
          ...
          <CardContent>
            <Grid container spacing={6}>
              ...
              <Grid item sm={4} xs={12}>
                <FormControl fullWidth>
                  <InputLabel id='plan-select'>Select Company</InputLabel>
                  <Select
                    fullWidth
                    value={plan}
                    id='select-plan'
              ...
              <Grid item sm={4} xs={12}>
                <FormControl fullWidth>
                  <InputLabel id='status-select'>Select User Type</InputLabel>
                  <Select
                    fullWidth
                    value={status}
                    id='select-status'
                  ...
                  >
                    ...
                    <MenuItem value='active'>Rider</MenuItem>
                    <MenuItem value='inactive'>Dealer</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
            </Grid>
