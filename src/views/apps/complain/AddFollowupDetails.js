...
import { Avatar, Card, CardContent, CardHeader, Fade, Grid, Table, TableBody, TableCell, TableContainer, TableRow } from '@mui/material'
...
const AddFollowupDetails = props => {
    ...
    // ** Props
    const { open, toggle, complainData } = props
    ...
    const onSubmit = async (data) => {
        const [error, result] = await asyncWrap(
            axios.post("/complaint/follow-up", {
                ...data,
    ...
    const getFollowupData = async () => {
        const [error, result] = await asyncWrap(axios.get(`/complaint/follow-up?complainId=${complainData?.ComplainId}&pageNo=-1`))
                                    ...
                                    <Table size='small' sx={{ width: '95%' }}>
                                        ...
                                        >
                                            <TableRow>
                                                ...
                                                <TableCell>{complainData?.CompanyName}</TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                                ...
                                                <TableCell>{complainData?.ShortDescription}</TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                                ...
                                                <TableCell>{complainData?.Descriptions}</TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                                ...
                                                <TableCell>{complainData?.FirstName + " " + complainData?.LastName}</TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                                ...
                                                <TableCell>{complainData?.AssignToFirstName + " " + complainData?.AssignToLastName}</TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                                ...
                                                <TableCell>{complainData?.TechnicianFirstName + " " + complainData?.TechnicianLastName}</TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                                ...
                                                <TableCell>{complainData?.ComplainDate}</TableCell>
                                            </TableRow>
                                            {/* <TableRow>
                                                <TableCell>
                                                    <Typography variant='subtitle2' sx={{ color: 'text.primary' }}>
                                        ...
                                        <TimelineItem key={index}>
                                            ...
                                            <TimelineContent>
                                                <Box sx={{ mb: 2, display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
                                                    ...
                                                    <Typography variant='caption'>  {item.FollowUpDate}</Typography>
                                                </Box>
