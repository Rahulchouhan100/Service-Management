...
const StepperLinearWithValidation = () => {
  ...
  const getUserData = async () => {
    const [error, result] = await asyncWrap(axios.get("/user"))
      ...
      case 0:
        return (
          <>
            ...
            <SidebarAddUser show={show} setShow={setShow} />
          </>
        )
      case 1:
        return (
            ...
            {steps.map((step, index) => {
              ...
              if (index === activeStep) {
                ...
                if (
                  ...
                  (complainDetailsError2.filePath || complainDetailsError2.complaintDate) &&
                  activeStep === 2
                ) {
                  labelProps.error = true
                } else {
